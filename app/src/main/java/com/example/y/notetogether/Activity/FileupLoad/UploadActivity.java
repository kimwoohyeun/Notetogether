...
/**
 * Created by kimwoohyeun on 2016-06-02.
 */
public class UploadActivity extends ActionBarActivity {
     ...
     * *******  File Path ************
     */
    final String uploadFilePath = "/mnt/shared/Downloads/sdcard/";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        messageText.setText("Uploading file path :- '/mnt/shared/Downloads/sdcard/" + uploadFileName + "'");

        /************* Php script path ****************/
        upLoadServerUri = "http://52.79.112.106:8000/";
