 ...
 */
public class ContentBoardRoomAdapter extends RecyclerView.Adapter<ContentBoardRoomAdapter.ViewHolder> implements Checkable {
    ...
    public ContentBoardRoomAdapter(Context context, ArrayList<RoomContents> contentList, int item_layout) {
    ...
    @Override
    public void onBindViewHolder(final ContentBoardRoomAdapter.ViewHolder holder, final int position) {
